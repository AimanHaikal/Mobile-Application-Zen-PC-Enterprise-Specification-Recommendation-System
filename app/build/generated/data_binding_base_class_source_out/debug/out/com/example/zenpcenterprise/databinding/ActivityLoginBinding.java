...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView staffLogin;
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull Button button,
      ...
      @NonNull Button loginButton, @NonNull TextView staffLogin, @NonNull TextView textView) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.staffLogin;
      TextView staffLogin = ViewBindings.findChildViewById(rootView, id);
      if (staffLogin == null) {
        break missingId;
      }
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, button, editTextTextEmailAddress,
          editTextTextPassword, loginButton, staffLogin, textView);
    }
